...
def __filter_for_transfertool(candidate_paths, rws, transfertool, retry_other_fts, logger):
...
def get_transfer_requests_and_source_replicas(total_workers=0, worker_number=0, limit=None, activity=None, older_than=None, rses=None, schemes=None,
    ...
    for rws in request_with_sources:
        ...
        candidate_paths = __filter_for_transfertool(candidate_paths, rws=rws, transfertool=transfertool, retry_other_fts=retry_other_fts, logger=logger)
        for transfer_path in candidate_paths:
